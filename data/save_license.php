...
//	$license_issue_date = $_POST["license_issue_date"];
	...
	$sql = "insert into tb_license (customer_id, photo, name, issue_date, issue_place, update_time, enable_flag) values ('".$user_id."', '".$upload_direcoty_full_path."', '".$license_name."', '".$license_issue_date."', '".$license_issue_place."', now(), true);";
	//echo $sql;
